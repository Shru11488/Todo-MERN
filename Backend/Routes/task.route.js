...
import { createTask, deleteTask, getAllTasks, getMyTask, updateTask, updateTaskStatus } from "../Controller/task.controller.js"

const router = express.Router()

router.post("/create", ProtectedRoute, isAdmin, createTask)
router.get("/all", ProtectedRoute, isAdmin, getAllTasks)
router.put("/update/:id", ProtectedRoute, isAdmin, updateTask)
